  ...
  return <section className="section-padding bg-muted/30">
      <div className="container-narrow">
        <div className="max-w-3xl mx-auto text-center animate-fade-in">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-semibold text-foreground mb-8 leading-tight">Tu web profesional, 
sin líos técnicos<br className="hidden sm:block" />
            <span className="text-primary my-[10px]">sin líos técnicos</span>
          </h2>

          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            Consigue una web profesional, minimalista y funcional sin arruinarte por el camino.{" "}
