      ...
      <div className="container-narrow">
        <div className="max-w-3xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            Ayudamos a emprendedores y pequeñas empresas a tener presencia online profesional, 
            minimalista y funcional. <strong className="text-foreground">Rápido, sin complicaciones técnicas.</strong>
          </p>
